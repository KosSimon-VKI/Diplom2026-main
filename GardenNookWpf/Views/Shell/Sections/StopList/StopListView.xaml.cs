...
using GardenNookWpf.Views.MainPanel.StopList;
using GardenNookWpf.Views.Shell;
using GardenNookWpf.Views.Shell.Controllers;

namespace GardenNookWpf.Views.Shell.Sections.StopList
{
    public partial class StopListView : UserControl, IMainSectionView
    {
